cd /d C:\Users\dengsikai\Desktop\RTT_TO_ATK\inspector_001_explorer_v3
set RTT_ROOT=
set ENV_ROOT=E:/RT_ThreadStudioIDE/RT-ThreadStudio/platform/env_released/env
set RTT_EXEC_PATH=E:/RT_ThreadStudioIDE/RT-ThreadStudio/repo/Extract/ToolChain_Support_Packages/ARM/GNU_Tools_for_ARM_Embedded_Processors/5.4.1/bin
