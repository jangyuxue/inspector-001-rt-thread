...
4. Flash the firmware to the Explorer STM32F407 V3 board.

The command-line build output is generated by RT-Thread Studio and is not committed to this repository.
